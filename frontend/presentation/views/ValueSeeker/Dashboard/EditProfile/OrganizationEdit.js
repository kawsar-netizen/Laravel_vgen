...
const OrganizationEdit = () => {
  ...
  useEffect(() => {
    ...
    loadInputData(`/seeker/edit-organization-profile`, token, setPersonalData);
  }, []);
  ...
  const testingImageUpload = async () => {
    ...
    const url = `${server}/seeker/update-organization-profile`;
    await fetch(url, {
      method: "POST",
      headers: {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    const editProfile = {
      company_name: values.company_name || personalData?.Details?.companyName,
      website: values.website || personalData?.Details?.website,
      founding_date:
        values.founding_date || personalData?.Details?.founding_date,
      ...
      tin_number: values.tin_number || personalData?.Details?.tin_number,
    ...
    testingImageUpload();
    sendData(`/seeker/update-organization-profile`, token, editProfile).then(
      (result) => {
        let responseJSON = result;
        if (responseJSON.success) {
          console.log(responseJSON);
          loadInputData(
            `/seeker/edit-organization-profile`,
            token,
            setPersonalData
          );
        ...
        <Grid item xs={12} md={8}>
            ...
            <Grid item xs={12} md={6}>
              <div className={styles.formInputField}>
                ...
                <input
                  type="text"
                  defaultValue={
                    personalData?.Details?.companyName || values.company_name
                  }
            ...
            <Grid item xs={12} md={6}>
              <div className={styles.formInputField}>
                ...
                <input
                  type="text"
                  defaultValue={
                    personalData?.Details?.website || values.website
                  }
          ...
          <div className={styles.formInputField}>
            ...
            <input
              type="text"
              defaultValue={
                personalData?.Details?.nid_number || values.nide_number
              }
          ...
          <div className={styles.formInputField}>
            ...
            <input
              type="date"
              defaultValue={
                personalData?.Details?.founding_date || values.founding_date
              }
              placeholder="Date"
              name="founding_date"
              className={styles.inputField}
          ...
          <Grid item xs={12} md={6}>
            <div className={styles.formInputField}>
              ...
              <Dropdown
                ...
                value={values.country || personalData?.Details?.country}
                onChange={handleChange}
              />
            </div>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <div className={styles.formInputField}>
              <label style={{ marginBottom: 10 }}>TIN Number</label>
              <input
                type="text"
                defaultValue={
                  personalData?.Details?.tin_number || values.tin_number
                }
