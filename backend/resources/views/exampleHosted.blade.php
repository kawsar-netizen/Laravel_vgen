            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="payment_method" class="form-control" id="payment_method" placeholder="payment_method" required>
                ...
                <div class="mb-3">
                    <label for="mobile">Partial Payment</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                        </div>
                        <input type="text" name="partial_payment" class="form-control" id="partial_payment" placeholder="partial_payment">
                        <div class="invalid-feedback" style="width: 100%;">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <label for="mobile">Tips</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                        </div>
                        <input type="text" name="tips" class="form-control" id="tips" placeholder="tips" required>
                        <div class="invalid-feedback" style="width: 100%;">
                            Tips is required.
                        </div>
                    </div>
