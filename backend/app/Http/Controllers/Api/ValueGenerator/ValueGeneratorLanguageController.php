...
class ValueGeneratorLanguageController extends Controller
{
    /**
    ...
    public function store(LanguageRequest $request)
    {
        try {
            $id = Auth::guard('vg-api')->user()->id;
            //Language_json
            //$data = LanguageService::store(json_decode($request->lang), $id);
    ...
    public function update(LanguageRequest $request, $id)
    {
        try {
            ...
            //Language_json
            //$data = LanguageService::update(json_decode($request->lang),$generatorId, $id);
